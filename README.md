...
|:-------:|:---------:|
| `:v2.5.8-alpine-3.17`, `:latest` | [View](variants/v2.5.8-alpine-3.17) |
...
```sh
docker run --rm -it --cap-add NET_ADMIN -v /path/to/server.conf:/etc/openvpn/server.conf theohbrothers/docker-openvpn:v2.5.8-alpine-3.17
```
